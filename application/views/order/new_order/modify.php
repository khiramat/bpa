<div class="card">
    <div class="card-header pt-2 pb-2">SIM変更
    ...
    <div class="card-body">
        ...
        <?php echo form_open('order/new_order/validate', array('class'=>'mainForm'));?>
            <div class="grid-table">
                <div class="row">
                    <div class="col-4 col-md-3 grid-th">変更種別選択</div>
                    <div class="col-8 col-md-9 grid-td">
                        <div class="col-md-6 p-0">
                        <?php echo form_dropdown('transactionTYPE', get_select_property('transaction_type_modify'), 
                ...
                <div class="row">
                    ...
                    <div class="col-8 col-md-9 grid-td">
                        <div class="col-md-6 p-0">
                            <select class="form-control form-control-sm" name="TENANT_ID">
                                <option value="">選択してください</option>
                                <?php if (isset($tenant_list)) : ?>
                                <?php foreach ($tenant_list as $tenant_info) : ?>
                                <option value="<?php echo $tenant_info->TENANT_ID;?>"><?php echo $tenant_info->TENANT_NAME;?></option>
                                <?php endforeach;?>
                                <?php endif;?>
                            </select>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-8 col-md-9 grid-td">
                        <label class="form-check form-check-inline mb-0">
                            <input type="radio" class="form-check-input" name="kensakukoumoku" value="1" <?php echo set_radio('kensakukoumoku', '1', TRUE);?> />MNP可否照会
                        </label>
                        <label class="form-check form-check-inline mb-0">
                            <input type="radio" class="form-check-input" name="kensakukoumoku" value="2" <?php echo set_radio('kensakukoumoku', '2');?> />WW累積額検索
                        </label>
                        <label class="form-check form-check-inline mb-0">
                            <input type="radio" class="form-check-input" name="kensakukoumoku" value="3" <?php echo set_radio('kensakukoumoku', '3');?> />WC累積額検索
                        </label>
                    </div>
                </div><!-- row end -->
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-8 col-md-3 grid-td">
                        <label class="form-check form-check-inline mb-0"> 
                            <input type="checkbox" class="form-check-input" value="1" name="cardsaihakoFLG" <?php echo set_checkbox('cardsaihakoFLG', '1');?>>再発行を行う
                        </label>
                    </div>
                    <div class="col-4 col-md-3 grid-th">NW未開通</div>
                    <div class="col-8 col-md-3 grid-td">
                        <label class="form-check form-check-inline mb-0"> 
                            <input type="checkbox" value="1" class="form-check-input" name="NWmikaituFLG" <?php echo set_checkbox('NWmikaituFLG', '1');?>>未開通とする
                        </label>
                    </div>
                </div><!-- row end -->
                <div class="row">
                ...
                <div class="row">
                    <div class="col-4 col-md-3 grid-th">PINロック解除コードリセット</div>
                    <div class="col-8 col-md-9 grid-td">
                        <label class="form-check form-check-inline mb-0"> 
                            <input type="checkbox" value="1" class="form-check-input" name="PINlockkaijoreset" <?php echo set_checkbox('PINlockkaijoreset', '1');?>>リセットする
                        </label>
                    </div>
                </div><!-- row end -->
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-8 col-md-3 grid-td">
                        <?php 
                            $contracttype_list = array('' => '選択してください') + get_select_property('contracttype');
                            echo form_dropdown('contracttype', $contracttype_list, 
                                            set_value('contracttype'), array('class' => 'form-control form-control-sm')); 
                        ?>
                    </div>
            ...
            <div class="row mt-30 buttons">
                ...
                <div class="col-6 col-md-3" style="display: none;" id="confirm" data-url="<?php echo site_url('order/new_order/sim_modify');?>">
